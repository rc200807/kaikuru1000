...
async function main() {
  ...
  for (const store of stores) {
    await prisma.store.upsert({
      ...
      update: {},
      create: { ...store, password: storePassword },
    })
  }
  ...
  // ライセンスキー（20件）
  const licenseKeys = [
    'KK-2024-AAAA-1111', 'KK-2024-BBBB-2222', 'KK-2024-CCCC-3333',
    'KK-2024-DDDD-4444', 'KK-2024-EEEE-5555', 'KK-2024-FFFF-6666',
    'KK-2024-GGGG-7777', 'KK-2024-HHHH-8888', 'KK-2024-IIII-9999',
    'KK-2024-JJJJ-0000', 'KK-2025-AAAA-1111', 'KK-2025-BBBB-2222',
    'KK-2025-CCCC-3333', 'KK-2025-DDDD-4444', 'KK-2025-EEEE-5555',
    'KK-2025-FFFF-6666', 'KK-2025-GGGG-7777', 'KK-2025-HHHH-8888',
    'KK-2025-IIII-9999', 'KK-2025-JJJJ-0000',
  ]
  ...
  if (licenseKey1 && !licenseKey1.isUsed) {
    const user1 = await prisma.user.upsert({
      ...
      update: {},
      create: {
        name: '山田太郎', furigana: 'やまだたろう',
        email: 'yamada@example.com', phone: '090-1234-5678',
        address: '東京都渋谷区渋谷1-1-1', password: userPassword,
        licenseKeyId: licenseKey1.id, storeId: tokyoStore?.id,
      },
    })
    await prisma.licenseKey.update({ where: { id: licenseKey1.id }, data: { isUsed: true } })
    if (tokyoStore) {
      await prisma.visitSchedule.create({
        data: { userId: user1.id, storeId: tokyoStore.id, visitDate: new Date('2026-03-25'), status: 'scheduled', note: '初回訪問' },
      })
    }
  ...
  if (licenseKey2 && !licenseKey2.isUsed) {
    await prisma.user.upsert({
      ...
      update: {},
      create: {
        name: '田中花子', furigana: 'たなかはなこ',
        email: 'tanaka@example.com', phone: '080-9876-5432',
        address: '大阪府大阪市北区天満1-2-3', password: userPassword,
        licenseKeyId: licenseKey2.id, storeId: osakaStore?.id,
      },
    })
    await prisma.licenseKey.update({ where: { id: licenseKey2.id }, data: { isUsed: true } })
