  ...
  return (
    <div style={{ padding: '24px 20px', maxWidth: 1280, margin: '0 auto', color: 'var(--md-sys-color-on-surface)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, gap: 12, flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ margin: '0 0 4px', fontSize: 24, fontWeight: 700 }}>セールスパートナー管理</h1>
      ...
      <div style={{ display: 'flex', gap: 4, marginBottom: 16, borderBottom: '1px solid var(--md-sys-color-outline-variant)' }}>
        <button
          ...
          style={{ padding: '8px 16px', background: 'transparent', border: 'none', borderBottom: tab === 'partners' ? '2px solid var(--md-sys-color-primary)' : '2px solid transparent', color: tab === 'partners' ? 'var(--md-sys-color-primary)' : 'var(--md-sys-color-on-surface-variant)', fontWeight: 600, cursor: 'pointer' }}
        >
          パートナー ({partners.length})
        </button>
        <button
          onClick={() => setTab('invitations')}
          style={{ padding: '8px 16px', background: 'transparent', border: 'none', borderBottom: tab === 'invitations' ? '2px solid var(--md-sys-color-primary)' : '2px solid transparent', color: tab === 'invitations' ? 'var(--md-sys-color-primary)' : 'var(--md-sys-color-on-surface-variant)', fontWeight: 600, cursor: 'pointer' }}
        >
