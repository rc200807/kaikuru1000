      ...
      <header className="bg-gray-800 text-white sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/admin/profile" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            {avatarPreview ? (
              <img src={avatarPreview} className="w-9 h-9 rounded-full object-cover border-2 border-gray-600" alt="" />
            ) : (
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            >
              {avatarPreview ? (
                ...
                <div className="w-24 h-24 rounded-full bg-gray-100 border-4 border-gray-200 flex items-center justify-center group-hover:bg-gray-200 transition-colors">
                  <span className="text-gray-700 text-3xl font-bold">{name?.[0] ?? '?'}</span>
                </div>
              )}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-700 pr-10"
                />
