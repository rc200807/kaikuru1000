    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-[#ededed] p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <h1 className="text-xl font-bold">連携パートナー ログイン</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-[#141414] rounded-2xl p-6 border border-[rgba(255,255,255,0.06)] space-y-4">
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full px-3 py-2 rounded-md bg-[#1a1a1a] border border-[rgba(255,255,255,0.08)] text-sm" />
          </div>
          <div>
            <label className="block text-xs text-[#a3a3a3] mb-1">パスワード</label>
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full px-3 py-2 rounded-md bg-[#1a1a1a] border border-[rgba(255,255,255,0.08)] text-sm" />
          </div>
          ...
          <p className="text-[11px] text-[#666] text-center mt-2">
            アカウントをお持ちでない場合は、管理者から発行された招待リンクをご利用ください
          </p>
        </form>
      </div>
    </div>
