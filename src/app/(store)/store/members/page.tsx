      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/store/members" className="text-sm font-medium text-white border-b border-white pb-0.5">
              メンバー
            </Link>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">店舗ポータルにログインできるアカウントを管理します</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">店舗アカウント（オーナー）</p>
          </div>
          <div className="px-6 py-4 flex items-center gap-4 border-b border-gray-100">
            ...
            <span className="text-xs font-medium bg-blue-50 text-blue-700 px-2.5 py-1 rounded-full">オーナー</span>
          </div>
          ...
          {members.length > 0 && (
            <>
              <div className="px-6 py-3 border-b border-gray-100 bg-gray-50">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">追加メンバー（{members.length}名）</p>
              </div>
              {members.map(member => (
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    minLength={6}
                    placeholder="6文字以上"
                    className="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-700 pr-12"
                  />
                  <button
                    type="button"
