            ...
            <div>
              ...
              <div className="space-y-2">
                {video.keyPoints.map((point, i) => (
                  ...
                  >
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--store-primary)] text-[var(--store-on-primary)] text-xs font-bold flex items-center justify-center mt-0.5">
                      {i + 1}
                    </span>
