...
export default function SysAdminOrdersPage() {
  ...
  return (
    <div style={{ padding: '24px 20px', maxWidth: 1080, margin: '0 auto', color: 'var(--md-sys-color-on-surface)' }}>
      <div style={{ marginBottom: 16 }}>
        <h1 style={{ margin: '0 0 4px', fontSize: 24, fontWeight: 700 }}>発注管理</h1>
              ...
              <div key={o.id} style={{ background: 'var(--md-sys-color-surface-container-low)', borderRadius: 12, padding: 16, border: '1px solid var(--md-sys-color-outline-variant)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 8 }}>
                  ...
                  <div style={{ fontSize: 12, color: 'var(--md-sys-color-on-surface-variant)' }}>
                    {new Date(o.createdAt).toLocaleString('ja-JP')} ／ 発注者: {o.placedByName}
                  </div>
                </div>
