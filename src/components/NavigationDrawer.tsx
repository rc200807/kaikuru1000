...
type NavItem = {
  ...
  matchPrefixes?: string[]  // 複数パスを束ねる項目のアクティブ判定用
}
...
const navItems: NavItem[] = [
  ...
  },
  {
    href: '/admin/stores',
    label: '店舗・運営管理',
    matchPrefixes: ['/admin/stores', '/admin/visits', '/admin/purchase-items', '/admin/operators', '/admin/store-members'],
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  {
    href: '/admin/line-scenarios',
    label: 'LINE自動配信',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 8.25h6m-6 3.75h3m-7.5 8.25v-2.625c0-.621-.504-1.125-1.125-1.125H3.75a48.454 48.454 0 0 1 0-9.75c.246-1.36 1.372-2.386 2.75-2.478a48.816 48.816 0 0 1 11 0c1.378.092 2.504 1.118 2.75 2.478.216 1.193.34 2.412.365 3.653m-8.865 9.847 3.536-3.536m0 0 3.535 3.536m-3.535-3.536V21" />
      </svg>
    ),
  },
  {
      ...
      <div className="relative shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]" ref={userMenuRef}>
        ...
        >
          ...
          <div className="min-w-0 flex-1 text-left">
            <p className="text-sm font-medium text-[#ededed] truncate">{user?.name ?? '管理者'}</p>
