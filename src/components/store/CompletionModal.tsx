    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-3 ${
          isWarn ? 'bg-amber-100' : 'bg-green-100'
        }`}>
          {isWarn ? (
            <svg className="w-9 h-9 text-amber-700" fill="none" stroke="currentColor" strokeWidth={2.2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" />
            </svg>
          ) : (
            <svg className="w-9 h-9 text-green-700" fill="none" stroke="currentColor" strokeWidth={2.2} viewBox="0 0 24 24">
