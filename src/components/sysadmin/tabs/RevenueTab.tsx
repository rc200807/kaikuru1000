...
import { Kpi, Panel, Empty, tooltipStyle, yen } from '@/components/sysadmin/ui'
...
export default function RevenueTab() {
  ...
  return (
    <div>
      <p style={{ margin: '0 0 16px', fontSize: 13, color: 'var(--md-sys-color-on-surface-variant)' }}>Stripe で決済された備品発注の売上データ</p>
      ...
      <Panel title="商品別売上ランキング（上位10）" style={{ marginTop: 16 }}>
        {r.productRanking.length === 0 ? <Empty text="売上データがありません" /> : (
