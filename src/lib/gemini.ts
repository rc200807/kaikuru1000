...
抽出する項目:
- documentType: 書類の種類。受付対象の4種のいずれかなら、その表記をそのまま使う（「運転免許証」「マイナンバーカード」「住所記載の日本国のパスポート」＝住所欄に現住所が記載された日本国旅券、「在留カード」）。いずれにも当てはまらない書類は、読み取った書類名をそのまま返す（例: 健康保険証。住所の記載がない日本国旅券は「パスポート」）
- name: 氏名（漢字フルネーム）
